 ...
 */
    ...
    */
      ...
      // All need to be assigned even if not used by language (no gaps in array)
         ...
         styles[Token.COMMENT1] = new SyntaxStyle(new Color(0x00961e),true,false);//(Color.black,true,false);
         ...
         styles[Token.LITERAL1] = new SyntaxStyle(new Color(0x00961e),false,false);//(new Color(0x650099),false,false);
         styles[Token.LITERAL2] = new SyntaxStyle(new Color(0x00961e),false,false);//(new Color(0x650099),false,true);
